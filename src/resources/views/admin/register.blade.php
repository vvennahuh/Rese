...
<div class="auth__wrap">
    ...
    <form action="/admin/register/Representative" method="post" class="form__item">
        @csrf
        <div class="form__item-user">
            <input type="text" class="form__input-item" name="username" placeholder="Representative Name" value="{{ old('username') }}">
        </div>
